...
class WebhookTest(TestCase):
    def setUp(self):
        ...
        self.request_domain = self.shop.url
    ...
    def test_postback_required_meta(self):
        ...
        response = self.client.post(url, body=self.request_data, type='application/json') #@TODO find out how to set post_raw_data in django Client
        ...
        response = self.client.post(url, body=self.request_data, CONTENT_TYPE='application/json', HTTP_X_SHOPIFY_HMAC_SHA256=self.request_hash, HTTP_X_SHOPIFY_SHOP_DOMAIN=self.request_domain) #@TODO find out how to set post_raw_data in django Client
