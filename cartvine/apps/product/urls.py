...
urlpatterns = patterns('',
    ...
    url(r'^(?P<slug>.+)/properties/base/$', login_required(csrf_exempt(ProductPropertiesView.as_view())), name='base_properties'),
    url(r'^(?P<slug>.+)/properties/basic/$', login_required(csrf_exempt(ProductPropertiesView.as_view())), name='basic_properties'),
    url(r'^(?P<slug>.+)/properties/plus/$', login_required(csrf_exempt(ProductPropertiesView.as_view())), name='plus_properties'),
