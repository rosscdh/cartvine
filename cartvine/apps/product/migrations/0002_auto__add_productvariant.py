...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('product_productvariant', (
            ...
            ('sku', self.gf('django.db.models.fields.CharField')(max_length=128, db_index=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('inventory_quantity', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('data', self.gf('jsonfield.fields.JSONField')()),
        ))
        db.send_create_signal('product', ['ProductVariant'])


    def backwards(self, orm):
        # Deleting model 'ProductVariant'
        db.delete_table('product_productvariant')
    ...
    models = {
        ...
        'product.productvariant': {
            ...
            'provider_id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
            'sku': ('django.db.models.fields.CharField', [], {'max_length': '128', 'db_index': 'True'}),
