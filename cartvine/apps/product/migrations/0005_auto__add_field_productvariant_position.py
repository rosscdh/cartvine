...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductVariant.position'
        db.add_column('product_productvariant', 'position',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductVariant.position'
        db.delete_column('product_productvariant', 'position')
