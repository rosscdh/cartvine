...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductVariant.sku'
        db.alter_column('product_productvariant', 'sku', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'ProductVariant.sku'
        db.alter_column('product_productvariant', 'sku', self.gf('django.db.models.fields.CharField')(default=None, max_length=128))
