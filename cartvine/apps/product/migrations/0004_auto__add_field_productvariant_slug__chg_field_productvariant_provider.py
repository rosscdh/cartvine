...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductVariant.slug'
        db.add_column('product_productvariant', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True),
                      keep_default=False)


        # Changing field 'ProductVariant.provider_id'
        db.alter_column('product_productvariant', 'provider_id', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'ProductVariant.slug'
        db.delete_column('product_productvariant', 'slug')


        # Changing field 'ProductVariant.provider_id'
        db.alter_column('product_productvariant', 'provider_id', self.gf('django.db.models.fields.IntegerField')(default=None))
    ...
    models = {
        ...
        'product.productvariant': {
            ...
            'data': ('jsonfield.fields.JSONField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inventory_quantity': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['product.Product']"}),
            'provider_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'db_index': 'True'}),
            'sku': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'db_index': 'True'}),
