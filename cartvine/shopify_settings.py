...
SHOPIFY_ACCESS_SCOPE = ['write_content', 'write_themes', 'write_products', 'write_customers', 'write_orders', 'write_script_tags', 'write_shipping', 'read_content', 'read_themes', 'read_products', 'read_customers', 'read_orders', 'read_script_tags', 'read_shipping']
